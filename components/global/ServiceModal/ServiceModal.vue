<template>
    <div
        v-show="modal.enable"
        class="formModal-overlay"
        @click.self="TOGGLE_MODAL({file: null,id:null,title:null,enable: false})"
    >
        <transition             
            name="slide"
        ...
        >
            <div
                v-if="modal.enable"
                id="serviceModal"
                class="formModal serviceModal h-auto w-11/12 md:w-1/2 p-5   rounded-md"
                :class="{active: modal.enable}"
            >
                <div class="flex flex-col w-full h-auto ">
                    ...
                    <div class="flex w-full h-auto justify-end items-center">
                        <div
                            ...
                            @click="TOGGLE_MODAL({file: null,id:null,title:null,enable: false})"
                        >
                            <svg
                    ...
                    <transition name="fade">
                        <form
                            v-if="!mailSent"
                            class="contact-form__container serviceModal__form-container"
                            @submit.prevent="sendForm"
                        >
                            <div class="flex w-full h-auto py-1  justify-center items-center text-center font-bold text-xl">
                                {{ modal.title }}
                            </div>
                            <div class="serviceModal__form-container">
                                ...
                                <div class="contact-form__item">
                                    ...
                                    <div
                                        v-show="errorInput.tel"
                                        class="contact-form__error"
                                    >
                                        Введите корректный мобильный телефон
                                    </div>
                                </div>
                                    ...
                                    <label class="contact-form__checkbox-container">
                                        <div class="contact-form__checkbox-wrapper focus-within:border-blue-500">
                                            <input
                                                ...
                                                :checked="check"
                                                @change="checkCheckbox($event.target)"
                                            >
                                            <svg
                                        ...
                                        <div class="contact-form__select-none">Я принимаю <a
                                            href="/policy.pdf"
                                            target="_blank"
                                        >соглашение сайта</a> об обработке персональных данных</div>
                                    </label>
                                    <span
                                        v-show="errorInput.checkbox"
                                        class="contact-form__error"
                                    >Необходимо дать согласие на обработку персональных данных</span>
                                </div>
                        ...
                        <div
                            v-else
                            class="flex w-full h-auto py-10 px-2 justify-center items-center  text-center font-bold text-xl"
                        >
                            {{ thxMessage }}
                        </div>
                    </transition>
