<template>
    <section class="service-section">
            <div class="service-section__top">
                <div class="container service-section-container service-section-container-top">
                    <div class="service-section__top-left" v-animate.repeat="'fadeInLeft'">
                        <h2 class="title-section service-section__title" v-show="title">{{ title }}</h2>
                        <div class="subtitle-section service-section__subtitle" v-show="subtitle">{{ subtitle }}</div>
                        <ul class="service-section__work-types" v-show="workTypes">
                            <li class="service-section__work-types-item" v-for="(item,index) in workTypes" :key="index">
                                <div class="service-section__work-types-img" v-show="item.img">
                ...
                <div class="service-section__top-right" v-show="img" v-animate.repeat="'fadeInRight'">
            ...
            <div class="service-section__bottom">
                <div class="container service-section-container">
                    <div class="service-section-container-bottom">
                        <ul class="service-section__bottom-service-list" v-show="serviceList" v-animate.repeat="'fadeInLeft'">
                            <li class="service-section__bottom-service-list-item" v-for="(item,index) in serviceList" :key="index">
                                ...
                                <div class="service-section__bottom-service-list-title" v-show="item.title">{{ item.title }}</div>
                                <div class="service-section__bottom-service-list-subtitle" v-show="item.subtitle">{{ item.subtitle }}</div>
                            </li>
                    ...
                    <div class="service-section__bottom-table" v-show="tablePrice" v-animate.repeat="'fadeInRight'">
                        ...
                        <div class="service-section__bottom-table-body" v-show="tablePrice.tableList">
        ...
        <div class="service-section__form" v-show="titleForm" v-animate.repeat="'fadeInRight'">
